; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\cygwin\home\uejima\PDFLibNet\libAFPDFLib\PDFPageInterop.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 180  : 			throw MEMFAIL;
	...
	lea	edx, DWORD PTR $T161023[esp+4]
	push	edx
	mov	DWORD PTR $T161023[esp+8], eax
...
; 54   : 		throw MEMFAIL;
	...
	mov	DWORD PTR $T161032[esp+4], eax
	push	OFFSET __TI1?AW4exception@?$DynArray@VpdfPageSelection@@@@
	lea	eax, DWORD PTR $T161032[esp+8]
	push	eax
	call	__CxxThrowException@8
$LN5@DynArray@7:
$LN1@DynArray@7:
...
; Function compile flags: /Ogtpy
; File c:\cygwin\home\uejima\pdflibnet\libafpdflib\pdfpageinterop.cpp
...
_nsel$85698 = -24					; size = 24
_dpi$ = 8						; size = 8
_hdc$ = 16						; size = 4
_color$ = 20						; size = 4
_linecolor$ = 24					; size = 4
_linewidth$ = 28					; size = 4
...
; 429  : 	old_brush = SelectObject(dc,GetStockObject(NULL_BRUSH));
	...
	push	5
	mov	DWORD PTR _old_pen$[esp+60], eax
	call	DWORD PTR __imp__GetStockObject@4
	push	eax
	push	edi
	call	esi
	mov	DWORD PTR _old_brush$[esp+56], eax

; 430  : 
; 431  : 	for(int i=0;i<arr->GetCount();i++){

	xor	eax, eax
	mov	DWORD PTR _i$85693[esp+56], eax
...
; 432  : 		const double mul = dpi / arr->operator [](i).dpi;
	...
	mov	edx, DWORD PTR tv308[esp+56]
	fdiv	QWORD PTR [edx+ecx+32]
	lea	eax, DWORD PTR [edx+ecx]

; 433  : 		CRect nsel =(CRect)arr->operator [](i);

	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _nsel$85698[esp+56], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _nsel$85698[esp+60], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR _nsel$85698[esp+64], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR _nsel$85698[esp+68], edx
	mov	ecx, DWORD PTR [eax+16]
	mov	DWORD PTR _nsel$85698[esp+72], ecx
	mov	edx, DWORD PTR [eax+20]
	mov	DWORD PTR _nsel$85698[esp+76], edx

; 434  : 
; 435  : 		nsel.left   = int(nsel.left   * mul);

	fild	DWORD PTR _nsel$85698[esp+56]
	fmul	ST(0), ST(1)
	call	__ftol2_sse

; 436  : 		nsel.top    = int(nsel.top    * mul);

	fild	DWORD PTR _nsel$85698[esp+60]
	mov	DWORD PTR _nsel$85698[esp+56], eax
	fmul	ST(0), ST(1)
	call	__ftol2_sse

; 437  : 		nsel.right  = int(nsel.right  * mul);

	fild	DWORD PTR _nsel$85698[esp+64]
	mov	DWORD PTR _nsel$85698[esp+60], eax
	fmul	ST(0), ST(1)
	call	__ftol2_sse

; 438  : 		nsel.bottom = int(nsel.bottom * mul);

	fimul	DWORD PTR _nsel$85698[esp+68]
	mov	esi, eax
	call	__ftol2_sse
...
; 444  : 		::Rectangle(dc,nsel.left,nsel.top,nsel.right,nsel.bottom);
	...
	mov	ecx, DWORD PTR _nsel$85698[esp+56]
	inc	eax
	push	eax
	inc	esi
	push	esi
	mov	DWORD PTR _nsel$85698[esp+76], eax
	mov	eax, DWORD PTR _nsel$85698[esp+68]
	push	eax
	push	ecx
	push	edi
	mov	DWORD PTR _nsel$85698[esp+84], esi
	call	DWORD PTR __imp__Rectangle@20

; 445  : 		::InvertRect(dc,&nsel);

	lea	edx, DWORD PTR _nsel$85698[esp+56]
	push	edx
	push	edi
	call	DWORD PTR __imp__InvertRect@8
	mov	eax, DWORD PTR _i$85693[esp+56]
	add	DWORD PTR tv308[esp+56], 40		; 00000028H
	inc	eax
	mov	DWORD PTR _i$85693[esp+56], eax
...
; 447  : 	SelectObject(dc,old_pen);
	...
	mov	eax, DWORD PTR _old_pen$[esp+56]
	push	eax
	push	edi
	call	esi
...
; 448  : 	SelectObject(dc,old_brush);
	...
	mov	ecx, DWORD PTR _old_brush$[esp+56]
	push	ecx
	push	edi
	call	esi
...
; 53   : {
	...
	mov	edi, eax
	add	esp, 4
	mov	DWORD PTR $T161284[esp+28], edi
	...
	push	OFFSET __TI1?AW4exception@?$DynArray@VpdfPageSelection@@@@
	lea	edx, DWORD PTR $T161293[esp+28]
	push	edx
	mov	DWORD PTR $T161293[esp+32], ebx
	call	__CxxThrowException@8
$LN12@PDFPageInt@2:
$LN3@PDFPageInt@2:
	xor	edi, edi
...
; 272  : 		((Page *)_pdfPage)->getDefaultCTM(lctm, dpi, dpi, 0,  gFalse, gFalse);
	...
	fst	QWORD PTR [esp+8]
	lea	eax, DWORD PTR _lctm$85536[esp+92]
	fstp	QWORD PTR [esp]
	push	eax
...
; 273  : 		*xd = (int)(lctm[0] * xu + lctm[2] * yu + lctm[4] + 0.5);
	...
	fld	QWORD PTR _lctm$85536[esp+64]
	fmul	ST(0), ST(1)
	fld	ST(2)
	fmul	QWORD PTR _lctm$85536[esp+80]
	faddp	ST(1), ST(0)
	fadd	QWORD PTR _lctm$85536[esp+96]
	fld	QWORD PTR __real@3fe0000000000000
	fadd	ST(1), ST(0)
	fxch	ST(1)
	call	__ftol2_sse
...
; 274  : 		*yd = (int)(lctm[1] * xu + lctm[3] * yu + lctm[5] + 0.5);
	...
	fxch	ST(1)
	fmul	QWORD PTR _lctm$85536[esp+72]
	mov	DWORD PTR [ebx], eax
	fxch	ST(2)
	fmul	QWORD PTR _lctm$85536[esp+88]
	faddp	ST(2), ST(0)
	fxch	ST(1)
	fadd	QWORD PTR _lctm$85536[esp+104]
...
_TEXT	SEGMENT
$T190781 = -28						; size = 4
_exitcode$190814 = -24					; size = 4
_exitcode$190807 = -24					; size = 4
$T190782 = -24						; size = 4
$T190778 = -24						; size = 4
_isUnicode$85607 = -20					; size = 4
_doc$ = -20						; size = 4
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
...
; 310  : 	GString *s1 = new GString();
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T190778[esp+48], eax
	xor	esi, esi
...
; 317  : 	TextOutputDev *txt= new TextOutputDev((TextOutputFunc)&WriteToGString,(void *)s1,gTrue,gFalse);
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T190782[esp+48], eax
	mov	DWORD PTR __$EHRec$[esp+56], 1
	cmp	eax, esi
	...
	mov	ebx, eax
	mov	DWORD PTR $T190781[esp+48], ebx
	jmp	SHORT $LN17@getText
$LN16@getText:
	mov	DWORD PTR $T190781[esp+48], esi
	mov	ebx, esi
$LN17@getText:
	mov	DWORD PTR __$EHRec$[esp+56], -1
...
; 318  : 	if(doc->IsBusy())
	...
	lea	ecx, DWORD PTR _exitcode$190807[esp+48]
	push	ecx
	push	eax
	mov	DWORD PTR _exitcode$190807[esp+56], esi
	call	ebp
	cmp	DWORD PTR _exitcode$190807[esp+48], 259	; 00000103H
...
; 319  : 		while(doc->IsBusy()) 
	...
	lea	ecx, DWORD PTR _exitcode$190814[esp+48]
	push	ecx
	push	eax
	mov	DWORD PTR _exitcode$190814[esp+56], esi
	call	ebp
	cmp	DWORD PTR _exitcode$190814[esp+48], 259	; 00000103H
	jne	SHORT $LN71@getText
...
; 331  : 			isUnicode = gTrue;
	...
	mov	DWORD PTR _isUnicode$85607[esp+48], 1
...
; 334  : 			isUnicode = gFalse;
	...
	mov	DWORD PTR _isUnicode$85607[esp+48], esi
$LN6@getText:
...
; 346  : 				  if (isUnicode) {
	...
	cmp	DWORD PTR _isUnicode$85607[esp+48], 0
...
; 360  : 			delete txt;	
	...
	mov	ecx, DWORD PTR $T190781[esp+52]
	add	esp, 4
	test	ecx, ecx
...
__unwindfunclet$?getText@PDFPageInterop@@QAEPA_WXZ$0:
	mov	eax, DWORD PTR $T190778[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__unwindfunclet$?getText@PDFPageInterop@@QAEPA_WXZ$1:
	mov	eax, DWORD PTR $T190782[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
...
; 302  : 	TextOutputDev *txt= new TextOutputDev((TextOutputFunc)fn,(void *)stream,gTrue,gFalse);
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T190883[esp+32], eax
...
_TEXT	SEGMENT
tv311 = -20						; size = 4
_exitcode$190927 = -20					; size = 4
_exitcode$190920 = -20					; size = 4
tv302 = -16						; size = 4
$T190906 = -16						; size = 4
__$EHRec$ = -12						; size = 12
...
; 257  : 		TextOutputDev *txt = new TextOutputDev(NULL,gTrue,gFalse,gFalse);
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T190906[esp+36], eax
...
; 258  : 		if(doc->IsBusy())
	...
	lea	ecx, DWORD PTR _exitcode$190920[esp+36]
	push	ecx
	mov	DWORD PTR _exitcode$190920[esp+40], ebp
	mov	ebp, DWORD PTR __imp__GetExitCodeThread@8
	push	eax
	call	ebp
	cmp	DWORD PTR _exitcode$190920[esp+36], 259	; 00000103H
...
; 259  : 			while(doc->IsBusy()) Sleep(50);
	...
	test	eax, eax
	je	SHORT $LN20@takeText
	lea	edx, DWORD PTR _exitcode$190927[esp+36]
	push	edx
	push	eax
	mov	DWORD PTR _exitcode$190927[esp+44], 0
	call	ebp
	cmp	DWORD PTR _exitcode$190927[esp+36], 259	; 00000103H
	jne	SHORT $LN20@takeText
	push	50					; 00000032H
	call	DWORD PTR __imp__Sleep@4
...
_TEXT	SEGMENT
$T190954 = -20						; size = 4
_exitcode$190969 = -16					; size = 4
_exitcode$190962 = -16					; size = 4
$T190955 = -16						; size = 4
__$EHRec$ = -12						; size = 12
...
; 216  : 		_images =(void *)new ImagesMemoryOutputDev();
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T190955[esp+40], eax
	...
	mov	DWORD PTR $T190954[esp+40], eax
	jmp	SHORT $LN8@extractIma
$LN7@extractIma:
	mov	DWORD PTR $T190954[esp+40], ebx
$LN8@extractIma:
	mov	eax, DWORD PTR $T190954[esp+40]
...
; 218  : 		if(doc->IsBusy())
	...
	lea	ecx, DWORD PTR _exitcode$190962[esp+40]
	push	ecx
	push	eax
	mov	DWORD PTR _exitcode$190962[esp+48], ebx
	call	edi
	cmp	DWORD PTR _exitcode$190962[esp+40], 259	; 00000103H
...
; 219  : 			while(doc->IsBusy()) Sleep(50);
	...
	cmp	eax, ebx
	je	SHORT $LN14@extractIma
	lea	edx, DWORD PTR _exitcode$190969[esp+40]
	push	edx
	push	eax
	mov	DWORD PTR _exitcode$190969[esp+48], ebx
	call	edi
	cmp	DWORD PTR _exitcode$190969[esp+40], 259	; 00000103H
	jne	SHORT $LN14@extractIma
	push	50					; 00000032H
	call	DWORD PTR __imp__Sleep@4
...
; 220  : 		doc->getDoc()->displayPage(img,this->_page,72,72,0,gTrue,gFalse,gFalse,0,0);
	...
	mov	ecx, DWORD PTR $T190954[esp+40]
	push	ebx
	push	ebx
	push	ebx
	push	ebx
...
; 161  : 			isUnicode = gTrue;
	...
	mov	DWORD PTR _isUnicode$85404[esp+64], 1
...
; 169  : 			ret = UTF8translate(s1->getCString());
	...
	push	eax
	mov	DWORD PTR _isUnicode$85404[esp+68], esi
	call	?UTF8translate@@YAPA_WQAD@Z		; UTF8translate
	add	esp, 4
...
; 176  : 				  if (isUnicode) {
	...
	cmp	DWORD PTR _isUnicode$85404[esp+64], 0
