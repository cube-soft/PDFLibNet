; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\projects\etc\PDFLibNet\libAFPDFLib\PageMemory.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 135  : 		if(width*_factorW<w || height*_factorH<h)
	...
	mov	DWORD PTR _w$80890[esp+20], ebp
	fstp	DWORD PTR tv332[esp+16]
	mov	DWORD PTR _h$80891[esp+20], ecx
	fld	DWORD PTR [esi+8]
...
; 151  : 			SRCCOPY);
	...
	call	__ftol2_sse
	fild	DWORD PTR _h$80891[esp+36]
	push	eax
	push	edi
	fmul	DWORD PTR [esi+12]
	call	__ftol2_sse
	fild	DWORD PTR _w$80890[esp+44]
	push	eax
	fmul	DWORD PTR [esi+8]
	call	__ftol2_sse
