; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\projects\PDFLibNet\libAFPDFLib\mupdfEngine.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\projects\pdflibnet\libafpdflib\mupdfengine.cpp
...
; 176  :     ctm = fz_concat(ctm, fz_translate(-page->mediabox.x0, -page->mediabox.y1));
	...
	push	ecx
	lea	eax, DWORD PTR $T158949[esp+60]
	fstp	DWORD PTR [esp]
	...
	lea	eax, DWORD PTR $T158950[esp+100]
	push	eax
	call	_fz_concat
...
; 177  :     ctm = fz_concat(ctm, fz_scale(zoom, -zoom));
	...
	mov	DWORD PTR [esi+12], edx
	mov	edx, DWORD PTR [eax+20]
	lea	eax, DWORD PTR $T158953[esp+60]
	mov	DWORD PTR [esi+16], ecx
	push	eax
	mov	DWORD PTR [esi+20], edx
	call	_fz_scale
	...
	mov	DWORD PTR [eax+16], ecx
	mov	DWORD PTR [eax+20], edx
	lea	eax, DWORD PTR $T158954[esp+100]
	push	eax
	call	_fz_concat
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR [eax+4]
...
; 180  :         ctm = fz_concat(ctm, fz_rotate(rotate));
	...
	push	ecx
	lea	ecx, DWORD PTR $T158957[esp+56]
	fstp	DWORD PTR [esp]
	push	ecx
	call	_fz_rotate
	mov	edx, DWORD PTR [eax]
	...
	mov	DWORD PTR [eax+16], ecx
	mov	DWORD PTR [eax+20], edx
	lea	eax, DWORD PTR $T158958[esp+100]
	push	eax
	call	_fz_concat
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR [eax+4]
...
; 111  : 	pdf_page* page = GetPage(pageNo);
	...
	mov	DWORD PTR _page$192467[esp+88], ebx
	call	_pdf_getpageobject
	add	esp, 8
	cmp	eax, ebx
	...
	push	eax
	push	edx
	lea	eax, DWORD PTR _page$192467[esp+88]
	push	eax
	call	_pdf_loadpage
	add	esp, 12					; 0000000cH
	test	eax, eax
...
$LN6@display:
	mov	edi, DWORD PTR _page$192467[esp+80]
$LN8@display:
...
; 121  :     ctm = viewctm(page, zoom, rotate);
	...
	push	ecx
	lea	esi, DWORD PTR $T192460[esp+88]
	fstp	DWORD PTR [esp]
...
; 122  :     bbox = fz_transformaabb(ctm, *pageRect);
	...
	mov	DWORD PTR [ecx+16], edx
	mov	DWORD PTR [ecx+20], eax
	lea	ecx, DWORD PTR $T192462[esp+120]
	push	ecx
...
; 124  : 	if(fz_rendertree(&image, _rast, page->tree, ctm, fz_roundrect(bbox), 1)){
	...
	lea	ecx, DWORD PTR $T192464[esp+96]
	push	ecx
	call	_fz_roundrect
	mov	edx, DWORD PTR [eax]
