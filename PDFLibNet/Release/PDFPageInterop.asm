; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\projects\etc\PDFLibNet\libAFPDFLib\PDFPageInterop.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 180  : 			throw MEMFAIL;
	...
	lea	edx, DWORD PTR $T161245[esp+4]
	push	edx
	mov	DWORD PTR $T161245[esp+8], eax
...
; 54   : 		throw MEMFAIL;
	...
	mov	DWORD PTR $T161254[esp+4], eax
	push	OFFSET __TI1?AW4exception@?$DynArray@VpdfPageSelection@@@@
	lea	eax, DWORD PTR $T161254[esp+8]
	push	eax
	call	__CxxThrowException@8
$LN5@DynArray@7:
$LN1@DynArray@7:
...
; Function compile flags: /Ogtpy
; File c:\projects\etc\pdflibnet\libafpdflib\pdfpageinterop.cpp
;	COMDAT ?RenderSelection@PDFPageInterop@@QAEXNJKKH@Z
_TEXT	SEGMENT
tv308 = -36						; size = 4
_old_pen$ = -32						; size = 4
_old_brush$ = -28					; size = 4
_nsel$85573 = -24					; size = 24
_dpi$ = 8						; size = 8
...
; 433  : 		CRect nsel =(CRect)arr->operator [](i);
	...
	add	eax, edx
	mov	DWORD PTR _nsel$85573[esp+48], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _nsel$85573[esp+52], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR _nsel$85573[esp+56], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR _nsel$85573[esp+60], edx
	mov	ecx, DWORD PTR [eax+16]
	mov	DWORD PTR _nsel$85573[esp+64], ecx
	mov	edx, DWORD PTR [eax+20]
	mov	DWORD PTR _nsel$85573[esp+68], edx

; 434  : 
; 435  : 		nsel.left   = int(nsel.left   * mul);

	fild	DWORD PTR _nsel$85573[esp+48]
	fmul	ST(0), ST(1)
	call	__ftol2_sse

; 436  : 		nsel.top    = int(nsel.top    * mul);

	fild	DWORD PTR _nsel$85573[esp+52]
	mov	DWORD PTR _nsel$85573[esp+48], eax
	fmul	ST(0), ST(1)
	call	__ftol2_sse

; 437  : 		nsel.right  = int(nsel.right  * mul);

	fild	DWORD PTR _nsel$85573[esp+56]
	mov	DWORD PTR _nsel$85573[esp+52], eax
	fmul	ST(0), ST(1)
	call	__ftol2_sse

; 438  : 		nsel.bottom = int(nsel.bottom * mul);

	fimul	DWORD PTR _nsel$85573[esp+60]
	mov	esi, eax
	call	__ftol2_sse
...
; 444  : 		::Rectangle(dc,nsel.left,nsel.top,nsel.right,nsel.bottom);
	...
	mov	ecx, DWORD PTR _nsel$85573[esp+48]
	inc	eax
	push	eax
	inc	esi
	push	esi
	mov	DWORD PTR _nsel$85573[esp+68], eax
	mov	eax, DWORD PTR _nsel$85573[esp+60]
	push	eax
	push	ecx
	push	edi
	mov	DWORD PTR _nsel$85573[esp+76], esi
	call	DWORD PTR __imp__Rectangle@20

; 445  : 		::InvertRect(dc,&nsel);

	lea	edx, DWORD PTR _nsel$85573[esp+48]
	push	edx
	push	edi
...
; 53   : {
	...
	mov	edi, eax
	add	esp, 4
	mov	DWORD PTR $T161507[esp+28], edi
	...
	push	OFFSET __TI1?AW4exception@?$DynArray@VpdfPageSelection@@@@
	lea	edx, DWORD PTR $T161516[esp+28]
	push	edx
	mov	DWORD PTR $T161516[esp+32], ebx
	call	__CxxThrowException@8
$LN12@PDFPageInt@2:
$LN3@PDFPageInt@2:
	xor	edi, edi
...
; 272  : 		((Page *)_pdfPage)->getDefaultCTM(lctm, dpi, dpi, 0,  gFalse, gFalse);
	...
	fst	QWORD PTR [esp+8]
	lea	eax, DWORD PTR _lctm$85411[esp+92]
	fstp	QWORD PTR [esp]
	push	eax
...
; 273  : 		*xd = (int)(lctm[0] * xu + lctm[2] * yu + lctm[4] + 0.5);
	...
	fld	QWORD PTR _lctm$85411[esp+64]
	fmul	ST(0), ST(1)
	fld	ST(2)
	fmul	QWORD PTR _lctm$85411[esp+80]
	faddp	ST(1), ST(0)
	fadd	QWORD PTR _lctm$85411[esp+96]
	fld	QWORD PTR __real@3fe0000000000000
	fadd	ST(1), ST(0)
	fxch	ST(1)
	call	__ftol2_sse
...
; 274  : 		*yd = (int)(lctm[1] * xu + lctm[3] * yu + lctm[5] + 0.5);
	...
	fxch	ST(1)
	fmul	QWORD PTR _lctm$85411[esp+72]
	mov	DWORD PTR [ebx], eax
	fxch	ST(2)
	fmul	QWORD PTR _lctm$85411[esp+88]
	faddp	ST(2), ST(0)
	fxch	ST(1)
	fadd	QWORD PTR _lctm$85411[esp+104]
...
_TEXT	SEGMENT
$T191034 = -28						; size = 4
_exitcode$191068 = -24					; size = 4
_exitcode$191061 = -24					; size = 4
$T191035 = -24						; size = 4
$T191031 = -24						; size = 4
_isUnicode$85482 = -20					; size = 4
_doc$ = -20						; size = 4
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
...
; 310  : 	GString *s1 = new GString();
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T191031[esp+48], eax
	xor	esi, esi
...
; 317  : 	TextOutputDev *txt= new TextOutputDev((TextOutputFunc)&WriteToGString,(void *)s1,gTrue,gFalse);
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T191035[esp+48], eax
	mov	DWORD PTR __$EHRec$[esp+56], 1
	cmp	eax, esi
	...
	mov	ebx, eax
	mov	DWORD PTR $T191034[esp+48], ebx
	jmp	SHORT $LN17@getText
$LN16@getText:
	mov	DWORD PTR $T191034[esp+48], esi
	mov	ebx, esi
$LN17@getText:
	mov	DWORD PTR __$EHRec$[esp+56], -1
...
; 318  : 	if(doc->IsBusy())
	...
	lea	ecx, DWORD PTR _exitcode$191061[esp+48]
	push	ecx
	push	eax
	mov	DWORD PTR _exitcode$191061[esp+56], esi
	call	ebp
	cmp	DWORD PTR _exitcode$191061[esp+48], 259	; 00000103H
...
; 319  : 		while(doc->IsBusy()) 
	...
	lea	ecx, DWORD PTR _exitcode$191068[esp+48]
	push	ecx
	push	eax
	mov	DWORD PTR _exitcode$191068[esp+56], esi
	call	ebp
	cmp	DWORD PTR _exitcode$191068[esp+48], 259	; 00000103H
	jne	SHORT $LN71@getText
...
; 331  : 			isUnicode = gTrue;
	...
	mov	DWORD PTR _isUnicode$85482[esp+48], 1
...
; 334  : 			isUnicode = gFalse;
	...
	mov	DWORD PTR _isUnicode$85482[esp+48], esi
$LN6@getText:
...
; 346  : 				  if (isUnicode) {
	...
	cmp	DWORD PTR _isUnicode$85482[esp+48], 0
...
; 360  : 			delete txt;	
	...
	mov	ecx, DWORD PTR $T191034[esp+52]
	add	esp, 4
	test	ecx, ecx
...
__unwindfunclet$?getText@PDFPageInterop@@QAEPA_WXZ$0:
	mov	eax, DWORD PTR $T191031[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__unwindfunclet$?getText@PDFPageInterop@@QAEPA_WXZ$1:
	mov	eax, DWORD PTR $T191035[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
...
; 302  : 	TextOutputDev *txt= new TextOutputDev((TextOutputFunc)fn,(void *)stream,gTrue,gFalse);
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T191136[esp+32], eax
...
_TEXT	SEGMENT
tv311 = -20						; size = 4
_exitcode$191181 = -20					; size = 4
_exitcode$191174 = -20					; size = 4
tv302 = -16						; size = 4
$T191159 = -16						; size = 4
__$EHRec$ = -12						; size = 12
...
; 257  : 		TextOutputDev *txt = new TextOutputDev(NULL,gTrue,gFalse,gFalse);
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T191159[esp+36], eax
...
; 258  : 		if(doc->IsBusy())
	...
	lea	ecx, DWORD PTR _exitcode$191174[esp+36]
	push	ecx
	mov	DWORD PTR _exitcode$191174[esp+40], ebp
	mov	ebp, DWORD PTR __imp__GetExitCodeThread@8
	push	eax
	call	ebp
	cmp	DWORD PTR _exitcode$191174[esp+36], 259	; 00000103H
...
; 259  : 			while(doc->IsBusy()) Sleep(50);
	...
	test	eax, eax
	je	SHORT $LN20@takeText
	lea	edx, DWORD PTR _exitcode$191181[esp+36]
	push	edx
	push	eax
	mov	DWORD PTR _exitcode$191181[esp+44], 0
	call	ebp
	cmp	DWORD PTR _exitcode$191181[esp+36], 259	; 00000103H
	jne	SHORT $LN20@takeText
	push	50					; 00000032H
	call	DWORD PTR __imp__Sleep@4
...
_TEXT	SEGMENT
$T191207 = -20						; size = 4
_exitcode$191223 = -16					; size = 4
_exitcode$191216 = -16					; size = 4
$T191208 = -16						; size = 4
__$EHRec$ = -12						; size = 12
...
; 216  : 		_images =(void *)new ImagesMemoryOutputDev();
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T191208[esp+40], eax
	...
	mov	DWORD PTR $T191207[esp+40], eax
	jmp	SHORT $LN8@extractIma
$LN7@extractIma:
	mov	DWORD PTR $T191207[esp+40], ebx
$LN8@extractIma:
	mov	eax, DWORD PTR $T191207[esp+40]
...
; 218  : 		if(doc->IsBusy())
	...
	lea	ecx, DWORD PTR _exitcode$191216[esp+40]
	push	ecx
	push	eax
	mov	DWORD PTR _exitcode$191216[esp+48], ebx
	call	edi
	cmp	DWORD PTR _exitcode$191216[esp+40], 259	; 00000103H
...
; 219  : 			while(doc->IsBusy()) Sleep(50);
	...
	cmp	eax, ebx
	je	SHORT $LN14@extractIma
	lea	edx, DWORD PTR _exitcode$191223[esp+40]
	push	edx
	push	eax
	mov	DWORD PTR _exitcode$191223[esp+48], ebx
	call	edi
	cmp	DWORD PTR _exitcode$191223[esp+40], 259	; 00000103H
	jne	SHORT $LN14@extractIma
	push	50					; 00000032H
	call	DWORD PTR __imp__Sleep@4
...
; 220  : 		doc->getDoc()->displayPage(img,this->_page,72,72,0,gTrue,gFalse,gFalse,0,0);
	...
	mov	ecx, DWORD PTR $T191207[esp+40]
	push	ebx
	push	ebx
	push	ebx
	push	ebx
...
; 161  : 			isUnicode = gTrue;
	...
	mov	DWORD PTR _isUnicode$85279[esp+64], 1
...
; 169  : 			ret = UTF8translate(s1->getCString());
	...
	push	eax
	mov	DWORD PTR _isUnicode$85279[esp+68], esi
	call	?UTF8translate@@YAPA_WQAD@Z		; UTF8translate
	add	esp, 4
...
; 176  : 				  if (isUnicode) {
	...
	cmp	DWORD PTR _isUnicode$85279[esp+64], 0
