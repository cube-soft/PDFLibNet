; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\projects\PDFLibNet\libAFPDFLib\jpeg.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\projects\pdflibnet\libafpdflib\jpeg.cpp
...
; 295  : 		 for (r=pbBmHdr->biHeight-1;r >=0 ;r--)
	...
	mov	eax, ebx
	sub	eax, edx
	mov	DWORD PTR $T159167[esp+48], eax
	mov	edi, ecx
$LL102@DibToSamps:
...
; 304  :                jsmpPixels[d][q+2] = lpPixels[nPixel+0]; //Blue
	...
	mov	eax, DWORD PTR $T159167[esp+48]
	add	ecx, 3
	cmp	ecx, eax
