; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\projects\PDFLibNet\libAFPDFLib\ImagesMemoryOutputDev.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 180  : 			throw MEMFAIL;
	...
	lea	edx, DWORD PTR $T159676[esp+4]
	push	edx
	mov	DWORD PTR $T159676[esp+8], eax
...
; 54   : 		throw MEMFAIL;
	...
	mov	DWORD PTR $T159688[esp+4], eax
	push	OFFSET __TI1?AW4exception@?$DynArray@UImageInfo@@@@
	lea	eax, DWORD PTR $T159688[esp+8]
	push	eax
	call	__CxxThrowException@8
$LN5@DynArray@2:
$LN1@DynArray@2:
...
; Function compile flags: /Ogtpy
; File c:\projects\pdflibnet\libafpdflib\imagesmemoryoutputdev.cpp
...
; Function compile flags: /Ogtpy
; File c:\projects\pdflibnet\libafpdflib\imagesmemoryoutputdev.h
_TEXT	ENDS
...
; Function compile flags: /Ogtpy
; File c:\projects\pdflibnet\xpdfwin\xpdf\gfxstate.h
_TEXT	ENDS
...
; 40   : 					throw "Memory allocation failure!";
	...
	lea	eax, DWORD PTR $T168044[esp+20]
	push	eax
	mov	DWORD PTR $T168044[esp+24], OFFSET ??_C@_0BL@BOIEBPCB@Memory?5allocation?5failure?$CB?$AA@
	call	__CxxThrowException@8
$LN30@drawImageM:
$LN12@drawImageM:
...
; 88   : 					throw "Memory allocation failure!";
	...
	push	OFFSET __TI2PAD
	lea	eax, DWORD PTR $T168048[esp+20]
	push	eax
	mov	DWORD PTR $T168048[esp+24], OFFSET ??_C@_0BL@BOIEBPCB@Memory?5allocation?5failure?$CB?$AA@
	call	__CxxThrowException@8
$LN31@drawImageM:
$LN29@drawImageM:
	int	3
...
; 18   : ImagesMemoryOutputDev::ImagesMemoryOutputDev() {
	...
	push	OFFSET __TI1?AW4exception@?$DynArray@UImageInfo@@@@
	lea	eax, DWORD PTR $T168108[esp+32]
	push	eax
	mov	DWORD PTR $T168108[esp+36], edi
	call	__CxxThrowException@8
$LN11@ImagesMemo@2:
$LN5@ImagesMemo@2:
...
; 123  : 		throw "Memory allocation failure!";
	...
	push	OFFSET __TI2PAD
	lea	eax, DWORD PTR $T174294[esp+200]
	push	eax
	mov	DWORD PTR $T174294[esp+204], OFFSET ??_C@_0BL@BOIEBPCB@Memory?5allocation?5failure?$CB?$AA@
	call	__CxxThrowException@8
$LN92@drawImage:
$LN27@drawImage:
...
; 157  : 					throw "Memory allocation failure!";
	...
	push	OFFSET __TI2PAD
	lea	ecx, DWORD PTR $T174295[esp+200]
	push	ecx
	mov	DWORD PTR $T174295[esp+204], OFFSET ??_C@_0BL@BOIEBPCB@Memory?5allocation?5failure?$CB?$AA@
	call	__CxxThrowException@8
$LN93@drawImage:
$LN85@drawImage:
...
; 183  : 					throw "Memory allocation failure!";
	...
	push	OFFSET __TI2PAD
	lea	eax, DWORD PTR $T174296[esp+200]
	push	eax
	mov	DWORD PTR $T174296[esp+204], OFFSET ??_C@_0BL@BOIEBPCB@Memory?5allocation?5failure?$CB?$AA@
	call	__CxxThrowException@8
$LN94@drawImage:
$LN19@drawImage:
...
; 195  :     imgStr = new ImageStream(str, width, colorMap->getNumPixelComps(),colorMap->getBits());
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T174298[esp+196], eax
	xor	ecx, ecx
	...
	mov	DWORD PTR $T174297[esp+196], eax
	jmp	SHORT $LN33@drawImage
$LN32@drawImage:
	mov	DWORD PTR $T174297[esp+196], ecx
$LN33@drawImage:

; 196  :     imgStr->reset();

	mov	ecx, DWORD PTR $T174297[esp+196]
...
; 237  :     delete imgStr;
	...
	mov	edi, DWORD PTR $T174297[esp+196]
	test	edi, edi
...
; 212  : 					throw "Memory allocation failure!";
	...
	push	OFFSET __TI2PAD
	lea	edx, DWORD PTR $T174301[esp+200]
	push	edx
	mov	DWORD PTR $T174301[esp+204], OFFSET ??_C@_0BL@BOIEBPCB@Memory?5allocation?5failure?$CB?$AA@
	call	__CxxThrowException@8
$LN95@drawImage:
$LN91@drawImage:
	int	3
