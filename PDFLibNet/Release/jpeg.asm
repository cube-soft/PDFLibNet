; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	c:\cygwin\home\uejima\PDFLibNet\libAFPDFLib\jpeg.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\cygwin\home\uejima\pdflibnet\libafpdflib\jpeg.cpp
...
; 195  :                int nBUsed = (p <(nUsed + 1)) ? 8 : nLastBits; //int nBUsed = (p <(nUsed 1)) ? 8 : nLastBits; 
	...
	mov	DWORD PTR _nBUsed$81576[esp+48], 8
	jmp	SHORT $LN63@DibToSamps
$LN62@DibToSamps:
	mov	ecx, DWORD PTR _nLastBits$[esp+48]
	mov	DWORD PTR _nBUsed$81576[esp+48], ecx
$LN63@DibToSamps:

; 196  : 			   for(b=0; b < nBUsed;b++)

	xor	ecx, ecx
	cmp	DWORD PTR _nBUsed$81576[esp+48], ecx
...
; 205  :                   q += 3;
	...
	add	edi, 3
	shr	dl, 7
	cmp	ecx, DWORD PTR _nBUsed$81576[esp+48]
	movzx	edx, dl
...
; 295  : 		 for (r=pbBmHdr->biHeight-1;r >=0 ;r--)
	...
	mov	eax, ebx
	sub	eax, edx
	mov	DWORD PTR $T159209[esp+48], eax
	mov	edi, ecx
$LL102@DibToSamps:
...
; 304  :                jsmpPixels[d][q+2] = lpPixels[nPixel+0]; //Blue
	...
	mov	eax, DWORD PTR $T159209[esp+48]
	add	ecx, 3
	cmp	ecx, eax
